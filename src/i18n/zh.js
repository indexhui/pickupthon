...
const intro = {
  ...
  introContent02:
    '透過此次黑客松，參與者可利用永續設計能理解現象背後的系統性根本問題並從服務設計手法，找到可以改善的方案，從中發揮影響力。',
  introDesign: '設計',
  introExchange: '交流',
  introCreative: '創意',
  introChallenge: '挑戰',
  introDesignContent: '用設計思維構思具有永續指標的產品和創新服務。',
  introExchangeContent: `透過跨國交流為參與者提供更廣闊的視野。`,
  introCreativeContent: '運用創意為社會提供永續設計的機會。',
  introChallengeContent: '參與設計挑戰，提出具有創意和可行性的永續解決方案。',
};
